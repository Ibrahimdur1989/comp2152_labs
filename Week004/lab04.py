...
# Lab04 - Q4: Define belt
belt = []

# Lab04 - Q1: Monster's Powers
monster_powers = {
    "Fire Magic": 2,
    "Freezing Time": 4,
    "Super Hearing": 6,
...
# Lab04 - Q5: The player collects loot
...
# Lab04 - Q6: The player collects more loot
...
# Lab04 - Q7: Organizing the loot belt
print("You're neat, so organiz your belt alphabetically: ")
belt.sort()
print("your belt: ", belt)
...
# Lab04 - Q2: Roll for Monster's Magic Power
input("Roll for monster's Magic Power (Press Enter)")
power_roll = random.choice([ "Fire Magic", "Freezing Time", "Super Hearing"])

# Lab04 - Q3: Increase the Monster's combat strength
